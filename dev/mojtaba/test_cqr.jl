...
scatter(xrange[1:50], y[1:50], label="true values", color=:green , ylabel="Boston Housing Price", linewidth=1)
plot!(xrange[1:50], y_pred_5[1:50], fillrange = y_pred_95[1:20], fillalpha = 0.1, label = "QR",
  color=:red, linewidth=0, framestyle=:box)
plot!(xrange[1:50], lb[1:50], fillrange = ub[1:20], fillalpha = 0.3, label = "CQR",
